...
public:
	...
	bool isMemberInRecruitInfoCollection(const char* nowLogin);		// 회사 회원이 올린 게시물이 recruitInfoCollectin 안에 있는지 확인
	void addRecruitInfo(RecruitInfo* recruitInfo);	// 채용 정보 등록 시, 새로운 채용 정보를 벡터에 추가
