...
public:
	...
	string getAddedRecruitInfoStats(string currentLoginId); //회사회원이 등록한 채용 정보 통계 반환
	//boundary -> 3.1 -> control
	string getAppliedRecruitInfoStats(string currentLoginId); //일반회원이 지원한 채용 정보 통계 반환
};
